...
//  MyLocations
//
//  Created by Fernando Gomez on 8/29/18.
         ...
         NotificationCenter.default.addObserver(forName: Notification.Name.NSManagedObjectContextObjectsDidChange, object: managedObjectContext, queue: OperationQueue.main) { notification in
            if self.isViewLoaded {
               ...
               if let dictionary = notification.userInfo {
                  print("These are inserted: \(dictionary["inserted"])")
                  print("These are deleted: \(dictionary["deleted"])")
                  print("These are updated: \(dictionary["updated"])")
               }
...
// Navigation bar extends to top of the screen
